...
<?php
$list_categorias=  Doctrine_Core::getTable('CategoriasTalento')->findAll();
...
{
  var $categorias=$("#talento_filters_categoria_id option");
  ...
  /*var $status=$("#talento_filters_is_active option");
