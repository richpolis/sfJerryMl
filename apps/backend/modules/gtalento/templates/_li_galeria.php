<!--li id="registro-<?php echo $registro->getId()?>" class="ui-widget-content ui-corner-tr picture"-->
  ...
  <img class="basic" src="<?php echo $registro->getThumbnailValid(); ?>"  title="<?php echo $registro->getTitulo(); ?>" description="<?php echo $registro->getContenido(ESC_RAW); ?>" url="<?php echo url_for('talento_galeria_edit',$registro,true)?>" />
  </a>
  </div>
