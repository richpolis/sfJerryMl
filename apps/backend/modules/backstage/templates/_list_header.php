...
<?php
$list_categorias=  Doctrine_Core::getTable('CategoriasBackstage')->findAll();
...
{
  var $categorias=$("#backstage_filters_categoria_id option");
  ...
  /*var $status=$("#backstage_filters_is_active option");
