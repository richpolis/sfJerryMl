...
<?php
$list_categorias=  Doctrine_Core::getTable('CategoriasVentas')->findAll();
...
{
  var $categorias=$("#ventas_filters_categoria_id option");
  ...
  /*var $status=$("#ventas_filters_is_active option");
