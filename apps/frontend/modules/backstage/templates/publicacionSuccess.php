...
<h1 class="titulo-pagina-h1">
    <span class="titulo-pagina-span">
        Backstage / <?php echo $publicacion_actual->getCategoriasBackstage()->getCategoria(); ?> 
    </span>
</h1>
...
<section class="publicacion">
    ...
    <div style="height: 50px;">
        <div class="control-pagina-regresar" style="float: left; margin-left: 20px; width: 200px;">
            <a href="<?php echo url_for('categorias_backstage', $publicacion_actual->getCategoriasBackstage()) ?>">
                Regresar
            </a>
        </div>
        <div class="social_networks-3" style="float: right; margin-right: 20px; width: 400px;">		
            <ul class="social-networks">
                <li>
                    <a rel="external" title="facebook" target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo urlencode(url_for('backstage', $publicacion_actual, true)) ?>&t=<?php echo $publicacion_actual->getTitulo(); ?>">
                        <span style="background:url(/images/facebook.png) no-repeat; width:26px; height:26px; display:block;"></span>
                    </a>
                </li>
                <li>
                    <a rel="external" title="twitter" href="http://twitter.com/home?status=<?php echo $sf_user->getMensajeTwitter() . urlencode(url_for('backstage', $publicacion_actual, true)) ?>" target="_black">
