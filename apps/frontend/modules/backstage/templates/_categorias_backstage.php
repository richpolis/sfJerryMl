<article class="categorias-publicaciones">
    ...
    <ul class="categorias-publicaciones-lista">
        ...
        <li class="categorias-publicaciones-lista-item current-lista-item"><?php echo link_to(ucwords("Ultimas Notas"),'backstage_ultimas_notas',array()) ?></li>
        <?php else:?>
        <li class="categorias-publicaciones-lista-item"><?php echo link_to(ucwords("Ultimas Notas"),'backstage_ultimas_notas',array()) ?></li>
        <?php endif;?>
        ...
        <li class="categorias-publicaciones-lista-item <?php echo ($categoria_actual->getCategoria()==$categoria->getCategoria()?"current-lista-item":"")?>">
            <?php echo link_to(ucwords($categoria->getCategoria()),'categorias_backstage',$categoria) ?>
        </li>
        <?php endforeach ?>
    </ul>
</article>
