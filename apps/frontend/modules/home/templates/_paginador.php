...
<div class="pagination">
    ...
    <a class="previous" href="<?php echo url_for('categorias_publicaciones',array('slug'=>$categoria_actual->getSlug(),'page'=>$pager->getPreviousPage())); ?>">«Anterior</a>
    <?php else: ?>
    ...
    <a class="next" href="<?php echo url_for('categorias_publicaciones',array('slug'=>$categoria_actual->getSlug(),'page'=>$pager->getPreviousPage())); ?>">Siguiente »</a>
    <?php else: ?>
