...
<head>
	...
	<style type="text/css">
		...
		.csshead {
			...
			background-image:  url(/images/mt/ww_bg.gif);
		...
		.logocss {
			...
			filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale src='/images/mt/mtlogo.png');
			display:block;
		}
		.logocss[class] {
			background-image: url(/images/mt/mtlogo.png);
		}
		.logocss span {
		...
		.logincss {
			...
			display:block;
			/* IE 5+/Win only filter */
			filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale src='/images/mt/login_bg.png');
		}
		/* Other browsers. IE ignores [attributes] */
		.logincss[class] {
			background-image: url(/images/mt/login_bg.png);
		}
...
<body>
	...
	<h2 class="defaultdomain">JerryML.com</h2>
