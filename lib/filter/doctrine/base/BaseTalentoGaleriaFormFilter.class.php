...
/**
 * TalentoGaleria filter form base class.
 *
 * @package    JerryML
 * @subpackage filter
 ...
 */
abstract class BaseTalentoGaleriaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'publicacion_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Talento'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('talento_galeria_filters[%s]');
