...
/**
 * BackstageGaleria filter form base class.
 *
 * @package    JerryML
 * @subpackage filter
 ...
 */
abstract class BaseBackstageGaleriaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'publicacion_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Backstage'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('backstage_galeria_filters[%s]');
