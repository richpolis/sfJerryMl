 ...
 */
class BackstageGaleria extends BaseBackstageGaleria
{
    ...
    public function getArchivoValid(){
        $elsefile='';
        switch($this->getTipoArchivo()){
            case BackstageGaleriaTable::$tipos_archivos['Link']:
                return $this->getArchivo();
                break;
            case BackstageGaleriaTable::$tipos_archivos['Imagen']:
                $elsefile='sin_imagen_galeria.jpg';
            case BackstageGaleriaTable::$tipos_archivos['Video']:
...
EOF
    ...
    public function save(Doctrine_Connection $conn = null) {
        ...
        if(!$this->getPosition()){
            $this->setPosition(Doctrine_Core::getTable('BackstageGaleria')->getMaximo());
        }
