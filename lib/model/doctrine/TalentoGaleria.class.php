 ...
 */
class TalentoGaleria extends BaseTalentoGaleria
{
	public function getThumbnailValid(){
        $elsefile='';
        switch($this->getTipoArchivo()){
            case TalentoGaleriaTable::$tipos_archivos['Link']:
                return $this->getThumbnail();
                break;
            case TalentoGaleriaTable::$tipos_archivos['PDF']:
                return "http://".$_SERVER['HTTP_HOST'].'/images/jerryml/talento/publicacion/pdf_icon.png';
                break;
            case TalentoGaleriaTable::$tipos_archivos['Imagen']:
            ...
            case TalentoGaleriaTable::$tipos_archivos['Video']:
                $file=$this->getThumbnail();
                if(file_exists(sfConfig::get('sf_upload_dir').'/publicaciones/thumbnails/'.$file)){
                    return "http://".$_SERVER['HTTP_HOST'].'/uploads/publicaciones/thumbnails/'.$file;
                }else{
    ...
    public function getRenderImagen($width,$height){
        ...
        switch($this->getTipoArchivo()){
            ...
            case TalentoGaleriaTable::$tipos_archivos['Video']:
                ...
                }elseif(file_exists(sfConfig::get('sf_upload_dir').'/publicaciones/'.$this->getThumbnail())){
                    return '/imagenes/publicaciones/'.$width.'/'.$height.'/'.$this->getThumbnail();
                }else{
                    if($elsefile=='')$elsefile='sin_video_galeria.jpg';
...
EOF
    ...
    public function save(Doctrine_Connection $conn = null) {
        ...
        sfRichSys::setDebugMensaje('Entro a Save de Talento Galeria');
        
        $this->setTipoArchivo($this->getTipoArchivoValid());
        switch($this->getTipoArchivo()){
            case TalentoGaleriaTable::$tipos_archivos['Link']:
                sfRichSys::setDebugMensaje('Entro a Tipos de Archivo Link');
        ...
        if(!$this->getPosition()){
            $this->setPosition(Doctrine_Core::getTable('TalentoGaleria')->getMaximo());
        }
